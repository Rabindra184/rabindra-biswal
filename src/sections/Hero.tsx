...
const FloatingKeyword: FC<{ text: string; index: number; scrollY: number }> = ({
  text,
  index,
  scrollY,
}) => {
...
const Hero: FC = () => {
  ...
  return (
    <section
      className={`hero-container fade-in-section ${
    ...
    >
      ...
      >
        ...
        >
          I&apos;m a{' '}
          <span className='highlight'>Senior QA Automation Engineer</span> with{' '}
          <span className='highlight'>12+ years</span> of experience in test
          automation, CI/CD integration, and quality engineering across
          healthcare technology, telecommunications, and e-commerce. I build
          automation frameworks using <span className='highlight'>Java</span>,{' '}
          <span className='highlight'>Kotlin</span>, and{' '}
          <span className='highlight'>Python</span>, and specialize in{' '}
          <span className='highlight'>Selenium</span>,{' '}
          <span className='highlight'>Appium</span>,{' '}
          <span className='highlight'>Playwright</span>, and{' '}
          <span className='highlight'>REST API testing</span>.
        </motion.p>
        <motion.div
        ...
        >
          <Button
            ...
            link='https://linkedin.com/in/rabindra-biswal'
            aria-label='LinkedIn profile of Rabindra Biswal'
            variant='primary'
            size='lg'
